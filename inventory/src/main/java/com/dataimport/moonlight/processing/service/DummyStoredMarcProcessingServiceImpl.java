...
public class DummyStoredMarcProcessingServiceImpl implements StoredMarcProcessingService {
  private static final Logger LOGGER = LoggerFactory.getLogger(DummyStoredMarcProcessingServiceImpl.class);
  ...
  public DummyStoredMarcProcessingServiceImpl(Vertx vertx) {
    this.vertx = vertx;
  }
