...
public class DummyCreatedInstanceProcessingServiceImpl implements CreatedInstanceProcessingService {
  private static final Logger LOGGER = LoggerFactory.getLogger(DummyCreatedInstanceProcessingServiceImpl.class);
  ...
  public DummyCreatedInstanceProcessingServiceImpl(Vertx vertx) {
    this.vertx = vertx;
  }
